...
<body>
	...
	<!-- Navbar -->
	<?php include_once("./templates/new_ordernv.php"); ?>
	<br /><br />
	...
	<div class="container" style="padding-bottom:50px;">
		<div class="row">
				...
				<div class="card">
					...
					<div class="card-body">
						<form id="get_order_data" onsubmit="return false">
							...
							<form id="get_GST" onsubmit="return false">
								<div class="form-group row">
									<label class="col-sm-3 col-form-label" align="right">GST No</label>
									<div class="col-sm-6">
										<input type="text" id="GST" name="GST" class="form-control form-control-sm" value="<?php echo (""); ?>">
									</div>
								</div>
								<div class="form-group row">
								...
								<div class="form-group row">
									<label class="col-sm-3 col-form-label" align="right">Customer Address*</label>
									<div class="col-sm-6">
										<input type="text" id="cust_name" name="cust_add" class="form-control form-control-sm" placeholder="Enter Address" required />
									</div>
								</div>
		    ...
		    <td>Rs.1540</td>
								...
								<center>
									<input type="submit" id="order_form" style="width:150px;" class="btn btn-dark" value="Order">
